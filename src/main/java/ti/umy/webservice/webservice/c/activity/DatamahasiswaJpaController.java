...
import ti.umy.webservice.webservice.c.activity.exceptions.NonexistentEntityException;
import ti.umy.webservice.webservice.c.activity.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.umy.webservice_webservice.c.activity_jar_0.0.1-SNAPSHOTPU");
